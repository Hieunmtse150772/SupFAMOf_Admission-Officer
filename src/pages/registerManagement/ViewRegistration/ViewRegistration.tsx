...
const ViewPostList = () => {
    ...
    return (
        <>{
            ...
            {(props.openConFirmModal && props.loading !== true && props.collabs !== null) && <ConfirmRegistrationModal handleSubmit={handler.handleSubmit} total={props.totalCollab} listCollab={props.collabsList} open={props.openConFirmModal} setOpenConfirmModal={handler.setOpenConfirmModal} registrationList={props.registrationList.data} ></ConfirmRegistrationModal>}
        </>
    )
}
